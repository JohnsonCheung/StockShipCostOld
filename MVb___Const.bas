...
Public Const SampleFb_Duty_Dta$ _
                                    = H & "DutyPrepay5\DutyPrepay5_Data.mdb"
Public Const SampleFb_Duty_Pgm$ _
                                    = H & "DutyPrepay5\DutyPrepay5.accdb"
Public Const SampleFx_KE24 _
                                    = H & "DutyPrepay5\SAPDownloadExcel\KE24 2010-01c.xls"
Public Const SampleFb_Duty_PgmBackup$ _
                                    = H & "DutyPrepay5\DutyPrepay5_Backup.accdb"
Public Const SampleFb_TaxCmp$ _
                                    = H1 & "QFinalSln\TaxExpCmp v1.3.accdb"
Public Const SampleFb_ShpRate$ _
