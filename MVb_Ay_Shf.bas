...
If B = "" Then
    AyShfItmEq = Array("", A)
Else
    AyShfItmEq = Array(Trim(RmvPfx(B, Itm & "=")), AyExlEleLik(A, Lik))
End If
End Function
...
For Each I In AyNz(OAy)
    If QItm = I Then AyShfQItm = QItm: OAy = AyExlEleAt(OAy, J): Exit Function
    J = J + 1
Next
End Function
...
OItmy = AyExlFstNEle(OItmy, NStar)
End Function
