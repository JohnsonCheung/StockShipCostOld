...
For Each X In AyNz(A)
    PushI DryRmvCol, AyExlEleAt(X, ColIx)
Next
End Function
...
Dim Dr
For Each Dr In A
    If AyIsEq(DrSel(Dr, IxAy), ValAy) Then PushI DryWhIxAyValAy, Dr
Next
End Function
