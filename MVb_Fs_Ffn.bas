...
FfnNotExistChk = MsgApLy("[File(s)] not found", O)
End Function
...
Dim E$
E = Err.Description
MsgWh CSub, "Cannot kill", "Ffn Er", A, E
End Sub
...
Sub FfnIsExistAss(A, Fun$)
If Not Fso.FileExists(A) Then Er Fun, "[File] not found", A
End Sub
