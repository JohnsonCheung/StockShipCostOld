Attribute VB_Name = "bb_RptRemark"
Option Explicit
...
'WTny = DbTny(W)
'End Function
'Function WStru$(Optional Tny0$)
'If Tny0 = "" Then
'    WStru = DbStru(W)
'Else
'    WStru = DbtnyStru(W, Tny0)
'End If
'End Function
...
'End Function
'
'Function WtnyStru$(Tny0)
'WtnyStru = DbtnyStru(W, Tny0)
'End Function
'Function WFb$()
'WFb = ApnWFb(Apn)
'End Function
...
'End Function
'
'Sub DbtImpTbl(A As Database, Tny0)
'Dim Tny$(), J%, S$
'Tny = DftNy(Tny0)
'For J = 0 To UB(Tny)
'    DbtDrp A, "#I" & Tny(J)
...
'Dim Nm$, Ty$, Extnm$, Ty As DAO.DataTypeEnum
'LinTTRstAsg A, Nm, Ty, Extnm
...
'End Function
'Function DbtNewWb(A As Database, Tny0) As Workbook
'
'End Function
'
...
'Next
'End Sub
'Sub DbDrpTbl(A As Database, Tny0)
...
'AyWdt = O
'End Function
'Function TnyStru$(Tny0)
'TnyStru = DbtnyStru(CurrentDb, Tny0)
'End Function
'Function TblStru$(T)
'TblStru = DbtStru(CurrentDb, T)
'End Function
'
'Function TblSql$(T, Optional WhBExpr$)
...
'DbtCrtDupKeyRecTbl CurrentDb, "#A", "Sku BchNo", "#B"
'TblBrw "#B"
'Stop
'TblDrp "#B"
'End Sub
...
'End Function
'Function DbtFnyAUTOQUOTE(A As Database, T) As String()
'Dim O$()
'O = DbtFny(A, T)
...
'End Sub
'
'Sub AcsTbl_Cls(A As Access.Application, Tny0)
...
'
'Sub TblCls(Tny0)
'AcsTbl_Cls Access.Application, Tny0
'End Sub
'
'Sub TblCls_1(T)
...
'End Function
'Function DaoTy_Ty$(A As DAO.DataTypeEnum)
'Dim O$
'Select Case A
...
'If ActTy <> Ty Then
'    DbtChkFldType = FmtQQ("Table[?] field[?] should have type[?], but now it has type[?]", T, F, DaoTy_Ty(Ty), DaoTy_Ty(ActTy))
'End If
'End Function
...
'CurrentDb.Execute "Delete * from Prm"
'If IsDev Then
'    CurrentDb.Execute "insert into Prm select * from Prm_C"
'Else
'    CurrentDb.Execute "insert into Prm select * from Prm_N"
'End If
'End Sub
'
'Function HasTbl(T) As Boolean
'HasTbl = DbHasTbl(CurrentDb, T)
'End Function
...
'End Function
'Function TblPutAt(A, At As Range) As Range
'Set TblPutAt = DbtPutAt(CurrentDb, A, At)
'End Function
'Function DbtPutAt(A As Database, T, At As Range) As Range
...
'End Function
'Function OyWhNmHasPfx(Oy, Pfx$)
'Dim O, I
'O = Oy
'Erase O
'For Each I In Oy
'    If HasPfx(I.Name, Pfx) Then PushObj O, I
'Next
'OyWhNmHasPfx = O
'End Function
...
'Set Db = Nothing
'End Sub
'Function WbRfh(A As Workbook, Fb$) As Workbook
...
'Set RgLo = O
'End Function
'Function SqNewLo(A, Optional WsNm$ = "Data", Optional LoNm$) As ListObject
'Dim R As Range
'Set R = SqNewA1(A, WsNm)
'Set SqNewLo = RgLo(R, LoNm)
'End Function
'Function RgVis(A As Range) As Range
'XlsVis A.Application
'Set RgVis = A
'End Function
'Sub DbtWrtFx(A As Database, Tny0, Fx$)
'DbtWb(A, Tny0).SaveAs Fx
'End Sub
'Function DbtWb(A As Database, Tny0) As Workbook
'
'End Function
...
'Next
'End Sub
'Sub TblWrtFx(Tny0, Fx$)
'DbtWrtFx CurrentDb, Tny0, Fx
'End Sub
...
'FfnIsExist = Dir(A) <> ""
'End Function
'Sub TblPutWs(T, Ws As Worksheet, Optional LoNm$)
...
'End Function
'Function TblNewWs(T, Optional WsNm$ = "Data", Optional LoNm$ = "Data") As Worksheet
'Set TblNewWs = LoWs(SqNewLo(TblSq(T), WsNm, LoNm))
'End Function
...
'End Function
'Sub FldsPutSq(A As DAO.Fields, Sq, Optional R& = 1, Optional NoTxtSngQ As Boolean)
...
'End Function
'Function TblLnkFb(Tny0, Fb$, Optional FbTny0) As String()
'TblLnkFb = DbtLnkFb(CurrentDb, Tny0, Fb, FbTny0)
'End Function
'Function DbtLnkFb(A As Database, Tny0, Fb$, Optional FbTny0) As String()
'Dim Tny$(), FbTny$()
'Tny = DftNy(Tny0)
'FbTny = DftNy(FbTny0)
'    Select Case True
...
'Dim Ay$()
'Ay = DbtFnyAUTOQUOTE(A, T)
'DbtStru = T & ": " & JnSpc(Ay)
'End Function
'Function DbtnyStru$(A As Database, Tny0)
'Dim Tny$(), O$(), J%
'Tny = DftNy(Tny0)
'For J = 0 To UB(Tny)
...
'End Sub
'
'Function PthFfnAy(A, Spec$) As String()
'Dim O$(), B$, P$
'P = PthEnsSfx(A)
'B = Dir(A & Spec)
'Dim J%
...
'End Sub
'
'Function SslyDic(A$()) As Dictionary
...
'End Function
'Function DrsWs(A As Drs, At As Range) As Worksheet
'Set DrsWs = SqRg(DrsSq(A), At)
'End Function
