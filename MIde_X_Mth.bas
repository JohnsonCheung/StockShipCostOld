...
Function MthFmCntAy(A As CodeModule, MthNm$) As FmCnt()
MthFmCntAy = SrcMthFmCntAy(MdSrc(A), MthNm)
End Function

Private Sub Z_MthFmCntAy()
Dim A() As FmCnt: A = MthFmCntAy(Md("Md_"), "XX")
Dim J%
For J = 0 To UB(A)
    FmCntDmp A(J)
Next
