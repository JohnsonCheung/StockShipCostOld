...
Const CSub$ = CMod & "MdPrpEnsExitPrpLin"
Dim L&
L = MdPrpInsExitPrpLno(A, PrpLno)
If L = 0 Then Exit Sub
A.InsertLines L, "Exit Property"
FunMsgNyApDmp CSub, "Exit Property is inserted", "Md PrpLno At", MdNm(A), PrpLno, L
End Sub

Private Sub MdPrpEnsLblXLin(A As CodeModule, PrpLno&)
Const CSub$ = CMod & "MdPrpEnsLblXLin"
...
If E <> ActLblXLin Then
    If L = 0 Then
        ...
        If Trc Then FunMsgApDmp CSub, "Inserted [at] with [line]", EndPrpLno, E
    Else
        A.ReplaceLine L, E
...
Const CSub$ = CMod & "MdPrpEnsOnErLin"
Dim L&
