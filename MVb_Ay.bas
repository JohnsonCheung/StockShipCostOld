...
Function AyIsEqChk(Ay1, Ay2, Optional Ay1Nm$ = "Exp", Optional Ay2Nm$ = "Act") As String()
Dim U&: U = UB(Ay1)
Dim O$()
...
Function ItmIsSel(Itm, Ay) As Boolean
If Sz(Ay) = 0 Then ItmIsSel = True: Exit Function
ItmIsSel = AyHas(Ay, Itm)
End Function
...
Private Sub ZZ_AyIsEqChk()
AyDmp AyIsEqChk(Array(1, 2, 3, 3, 4), Array(1, 2, 3, 4, 4))
End Sub
...
Private Sub ZZ_AyExlEmpEleAtEnd()
...
Private Sub Z_AyIsEqChk()
AyDmp AyIsEqChk(Array(1, 2, 3, 3, 4), Array(1, 2, 3, 4, 4))
End Sub

Private Sub Z_AyFTIxBrk()
Dim A(): A = Array(1, 2, 3, 4)
