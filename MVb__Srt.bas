...
Dim Exp, Act
Dim A
A = Array(1, 2, 3, 4, 5): Exp = A:                    Act = AySrt(A):        AyIsEqAss Exp, Act
A = Array(1, 2, 3, 4, 5): Exp = Array(5, 4, 3, 2, 1): Act = AySrt(A, True): AyIsEqAss Exp, Act
A = Array(":", "~", "P"): Exp = Array(":", "P", "~"): Act = AySrt(A):       AyIsEqAss Exp, Act
'-----------------
Erase A
Push A, ":PjUpdTm:Sub"
Push A, ":MthBrk:Function"
...
Dim A: A = Array("A", "B", "C", "D", "E")
AyIsEqAss Array(0, 1, 2, 3, 4), AySrtIntoIxAy(A)
AyIsEqAss Array(4, 3, 2, 1, 0), AySrtIntoIxAy(A, True)
End Sub
